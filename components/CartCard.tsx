...
export default function CartCard({ limit, title, image, price, id, index, quantity, inventory }: { limit: number; title: string; image: string; price: number; id: number; index: number; quantity: number; inventory: number;}) {
